...
public class XRecyclerView extends RecyclerView {
    ...
    private void init() {
        ...
        setRefreshProgressStyle(ProgressStyle.BallClipRotatePulse);//可以自定义下拉刷新的样式
        setLoadingMoreProgressStyle(ProgressStyle.BallClipRotatePulse);//可以自定义上拉加载的样式
        setArrowImageView(R.drawable.iconfont_downgrey);//设置下拉箭头
    }
